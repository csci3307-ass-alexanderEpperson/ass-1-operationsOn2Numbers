...
public class MultiplyOperatorFor2numbers extends OperatorFor2numbers implements Multiply {
	...
	// public class MultiplyOperatorFor2numbers extends OperatorFor2numbers
	// implements Multiply, Has2numbers {

	public MultiplyOperatorFor2numbers() {
		// super(); // NOTE ilker if you don't call parent's constructor in a
		// child class' constructor, java will automagically call default
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.mycompany.basicmathoperations.oop.Multiply#multiply(float,
	 * float)
	 */
	@Override
